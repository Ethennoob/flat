...
jQuery(document).ready(function($) {
    ...
    if ($('#dm_contact_form_1').length > 0 && ($('#dm_contact_form_1 #subject').val() == 'startup-support' || $('#dm_contact_form_1 #subject').val() == 'startup-wordpress-support' || $('#dm_contact_form_1 #subject').val() == 'flat-ui-support' || $('#dm_contact_form_1 #subject').val() == 'qards-support')) {
        $('#dm_contact_form_1 #order_number').closest('div').show();
    }

    $('#dm_contact_form_1').on('change', '#subject', function() {
        if ($(this).val() == 'startup-support' || $(this).val() == 'startup-wordpress-support' || $(this).val() == 'flat-ui-support' || $(this).val() == 'qards-support') {
            $('#dm_contact_form_1 #order_number').closest('div').show();
        } else {
