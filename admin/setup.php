...
<body style="background: #ddd;">
   ...
   <div>
      <ul class="nav navbar-nav pull-right">
         ...
         <li class="active"><a href="setup.php">设置</a></li>
         ...
         <li class="dropdown">
            ...
            <li><a href="iframe/updatepwd.php" target="mainFrame">修改密码</a></li>
               <li class="divider"></li>
...
<div class="row">
        ...
        <div class="leftnav">
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li><a href="iframe/updatepwd.php" target="mainFrame">修改密码</a></li>
                <li><a href="iframe/seo-config.php" target="mainFrame">SEO设置</a></li>
            </ul>
         </div>
        </div>
