            ...
            createNav: function() {
                ...
                if (this.options.navstyle != 'none') {
                    ...
                    if (this.options.navshowpreview) {
                        ...
                        var y = $("<div class='html5zoo-nav-preview-arrow-" + this.id + "' style='display:block;position:absolute;width:750px;height:350px;background:url(\"" + this.options.skinsfolder + this.options.navpreviewarrowimage + "\") no-repeat center center;' ></div>");
