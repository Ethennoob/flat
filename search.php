...
<div id="content-wrapper">
    ...
    <?php $records=get_search_by_type();
    if(is_array($records))    
   {  
    ...
    ?>
                    <li>
                        ...
                        <a href="article.php?id=<?php echo $rs['id'];?>"><img width="424" height="113" src="do.php?arti=show&id=<?php echo $rs['id']."&".time();?>" class="attachment-category wp-post-image"/></a>
                               
                        </div><!--end archives-thumb-->

                        <h2><a href="article.php?id=<?php echo $rs['id'];?>" rel="bookmark" title="Permanent Link to How Time Perception Impacts Interaction Design"><?php echo $rs['title'];?></a></h2>
                    ...
                    <?php }}else{?>
                    <div class="alert alert-info">此关键词搜索结果无内容</div>
                    <?php } ?>
                                    <li>
        ...
        <div style="clear:both;"></div>
        <!-- <div class="paginator">
            <ul class='page-numbers'><li><span class='title'>Pages:</span></li>
            <li><span class='page-numbers current'>1</span></li>
            <li><a class='page-numbers' href='design/page/2/'>2</a></li>
            <li><a class='page-numbers' href='design/page/3/'>3</a></li>
            <li><a class='page-numbers' href='design/page/4/'>4</a></li>
            <li><span class="page-numbers dots">&hellip;</span></li>
            <li><a class='page-numbers' href='design/page/26/'>26</a></li>
            <li><a class="next page-numbers" href="design/page/2/">&raquo;</a></li>
        </ul>
        </div> --><!--end paginator -->
